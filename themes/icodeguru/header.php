                ...
                <div class="row nav-row">
                    <div class="col-lg-3 col-md-12 logo">
                        <a href="<?php echo esc_url(home_url('/')); ?>">
                            <h2 class="mt-3"> <span class="font-weight-bold">iCode</span> Guru</h2>
                        </a>
                    ...
                    <div class="col-lg-3 col-md-12 d-flex align-items-center justify-content-between">
                    <a class="nav-btn m-1" href="<?php echo esc_url(home_url('/apply-for-funding')); ?>">
                                ...
                                <a class="nav-btn m-1" href="<?php echo esc_url(home_url('/')); ?>">
